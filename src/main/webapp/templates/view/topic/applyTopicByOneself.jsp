...
<div class="kit-doc">
    <!--这里写页面的代码-->
    <blockquote class="layui-elem-quote">这是关于申请课题（自选）页面</blockquote>
    ...
    <form class="layui-form" action="">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input name="topicName" lay-verify="required" autocomplete="off" class="layui-input" type="text"  style="width: 300px">
            </div>
        </div>
        <div class="layui-form-item">
