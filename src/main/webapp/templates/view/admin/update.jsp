...
<div class="kit-doc">
    <form id="adminForm" class="layui-form layui-form-pane" action="">
        ...
        <%--<div class="layui-form-item">--%>
            ...
            <%--<div class="layui-input-block">--%>
                <%--<input name="kitAdminPassword" value=${kitAdminUsername} lay-verify="required" placeholder="请输入你的密码" autocomplete="off" class="layui-input" type="text">--%>
            <%--</div>--%>
        <%--</div>--%>
        ...
        <%--<div class="layui-form-item" >--%>
            ...
            <%--<div class=" layui-upload-drag" id="img" style="border-left: 0px;">--%>
                ...
                <%--<p>点击上传头像</p>--%>
                <%--<img src=${updateAdmin.kitAdminImgUrl} id="demo1"  style="position: absolute;height: 137px;width: 137px;margin: -106px auto auto -30px;display: none" />--%>
            <%--</div>--%>
        <%--</div>--%>
