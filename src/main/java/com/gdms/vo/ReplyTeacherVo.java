...
public class ReplyTeacherVo {
    ...
    public ReplyTeacherVo(Integer id, String tid, String tname, String sex, String workTime, String hdegree, String teachingDirection, String position, String department, String major, String phone, String email) {
        this.id = id;
        this.tid = tid;
        this.tname = tname;
        this.sex = sex;
