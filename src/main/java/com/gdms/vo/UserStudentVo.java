...
public class UserStudentVo {
    ...
    public UserStudentVo(Integer id, String sid, String name, String sex, String department, String major, String grade, String sclass, String phone, String email, String adviserTname, String replygroupName) {
        this.id = id;
        this.sid = sid;
        this.name = name;
        this.sex = sex;
