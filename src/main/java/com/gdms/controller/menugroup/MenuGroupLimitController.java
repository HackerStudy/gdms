package com.gdms.controller.menugroup;
...
public class MenuGroupLimitController {
    private Logger log = Logger.getLogger(MenuGroupLimitController.class);
    ...
    public Object getGroup(HttpServletRequest request){
        ...
        mv.setViewName("/view/menu/menu_set");
    ...
    public ModelAndView goUpdate(HttpServletRequest request){
        ...
        // 删除
        mv.setViewName("/view/menu/update");
