            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input name="phone" value="${teacherInfoVo.phone}" lay-verify="required|phone|number" autocomplete="off" class="layui-input" type="text" style="width: 200px">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script type="text/javascript">
    layui.use(['element','form','upload'], function(){
        ...
        form.on('submit(add)', function(data){
            $.post("<%=basePath%>person/updateTeacher",data.field,function(data){
                // 获取 session
                if(data.code!=200){
