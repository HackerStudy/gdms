...
<div class="kit-doc">
    <!--这里写页面的代码-->
    <blockquote class="layui-elem-quote">这是关于查看所有学生毕设成绩的页面</blockquote>
    <div class="kit-doc-title">
        <fieldset>
            <legend><a name="blockquote">所有学生的毕设成绩</a></legend>
        </fieldset>
    </div>
    <div>
    </div>
...
<script>
    ...
    layui.use('table', function() {
        ...
        table.render({
            elem: '#test'
            , url: '<%=basePath%>score/StudentScoreGetAllJson'
            , method: 'post'
            , cols: [[
