                ...
                <form class="layui-form" action="">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="kitAdminUsername" lay-verify="required" lay-vertype="tips" placeholder="请输入账号" value="${admin.kitAdminUsername}" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="checkbox" name="roleIds[4]" title="超级管理员" value="${admin.groupId}" checked="checked" disabled>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
