...
<div class="kit-doc">
    <!--这里写页面的代码-->
    <blockquote class="layui-elem-quote">这是关于学生答辩成绩的信息</blockquote>
    <div class="kit-doc-title">
        <fieldset>
            <legend><a name="blockquote">组内学生答辩成绩</a></legend>
        </fieldset>
    </div>
    <div>
    </div>
...
<script>
    ...
    layui.use('table', function() {
        ...
        table.render({
            elem: '#test'
            , url: '<%=basePath%>reply/groupStudentScoreGetAllJson'
            , method: 'post'
            , cols: [[
