...
<div class="kit-doc">
    <!--这里写页面的代码-->
    <blockquote class="layui-elem-quote">这是关于指导老师所带学会学生的页面</blockquote>
    <div class="kit-doc-title">
        <fieldset>
            <legend><a name="blockquote">所带学生的信息</a></legend>
        </fieldset>
    </div>
    <div>
    </div>
...
<script>
    ...
    layui.use('table', function() {
        ...
        table.render({
            elem: '#test'
            , url: '<%=basePath%>advise/AllCarryStudentGetAllJson'
            , method: 'post'
            , cols: [[
                ...
                ,{field:'department', title: '院部',width:220}
