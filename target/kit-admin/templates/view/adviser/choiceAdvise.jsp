...
<div class="kit-doc">
    <!--这里写页面的代码-->
    <blockquote class="layui-elem-quote">这是关于指导老师选择的页面</blockquote>
    ...
    <script type="text/html" id="barDemo">
        <button class="layui-btn layui-btn-sm layui-btn-danger" lay-event="apply"><i class="layui-icon">&#xe609;</i>申请</button>
    </script>
</div>
