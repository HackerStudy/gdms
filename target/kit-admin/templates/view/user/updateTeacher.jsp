...
<div class="kit-doc">
    <form class="layui-form layui-form-pane" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="did" value=${teacher.did} lay-verify="required" autocomplete="off" class="layui-input" type="text">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="mid" value=${teacher.mid} lay-verify="required"  autocomplete="off" class="layui-input" type="text">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="identityId" value=${teacher.identityId} lay-verify="required"  autocomplete="off" class="layui-input" type="text">
            </div>
        </div>
